...
def runVAD(audio_file, force_reload=False, USE_ONNX=False, vad_threshold:float=0.2, chunk_threshold:float=0.3):
    """
...
if __name__=="__main__":
    ...
    parser.add_argument("-vt", metavar='--VAD_THRESHOLD', default=0.2, type=float, help = "[Default:0.2] param type:number.", required=False)
